                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            ...
                            <h4 class="modal-title text-center" id="ModalTitle">Sửa thông tin lớp</h4>
                    </div>
                    <div class="modal-body">
                        <form id="form" class="form-horizontal">
                        <div class="form-group">
                            <label for="Malop" class="col-sm-2 control-label">Mã lớp</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="Tenlop" class="col-sm-2 control-label">Tên lớp</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="Tenlop" name="TenLop" value="<%:Model.TenLop %>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="Khoa" class="col-sm-2 control-label">Khoa</label>
                            <div class="col-sm-10">
                                <%=Html.DropDownList("MaKhoa", Model.listKhoa)%>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="Chuyennganh" class="col-sm-2 control-label">Chuyên ngành</label>
                            <div class="col-sm-10" id="Loadcbx">
                                 <%=Html.DropDownList("MaChuyenNganh", Model.listChuyenNganh)%>                   
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="Name" class="col-sm-2 control-label">Niên khóa</label>
                            <div class="col-sm-10">
